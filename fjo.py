...
token = '5346598071:AAFQP1F3IO1Hzea2ECj0a5WsyP_dn5-_fUk'
...
shipping_optionss = [ShippingOption(id='1111', title='fsdfsdfsfs').add_price(LabeledPrice('11111', 10000))]
...
def shipping(shipping_query):
    ...
    bot.answer_shipping_query(shipping_query_id=shipping_query.id, shipping_options=shipping_optionss, ok=True)
